...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        header("Location: reset_password_students.php");
        exit();
    } else {
...
<body>
   ...
   <div class="container-fluid vh-100 d-flex justify-content-center align-items-center">
     <div class="card p-5 shadow rounded-4 text-center login-card" style="max-width:500px; width:100%;">
       ...
       <form action="verify_code_students.php" method="POST">
       ...
       <div class="text-center">
         <p class="small mb-0 mt-2">Go back to <a href="login_students.php" class="text-decoration-none fw-bold">Login</a></p>
       </div>
     </div>
   </div>
