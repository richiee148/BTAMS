...
?>
      ...
      <form action="forgot_password_admins.php" method="POST">
      ...
      <div class="text-center">
        <p class="small mb-0 mt-2">Remembered your password? <a href="login_admins.php" class="text-decoration-none fw-bold">Login</a></p>
      </div>
    </div>
  </div>
