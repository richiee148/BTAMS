...
<?php endif; ?>
    ...
    <!-- Login form -->
    <form action="validate_admins.php" method="POST">
      ...
      <div class="text-start mb-3">
        <a href="forgot_password_admins.php" class="text-decoration-none">Forgot password?</a>
      </div>

      <button type="submit" class="btn btn-primary w-100 rounded-pill mb-3">Login</button>
    </form>

    <!-- Social login + signup links (outside form) -->
    <p class="mb-2 text-center text-muted">Sign up with</p>
    <div class="d-flex justify-content-center gap-2 mb-4">
        <a href="google_login_admins.php" class="btn btn-google rounded-pill px-3"><i class="bi bi-google"></i></a>
    </div>

    <p class="text-center mb-0">Don’t have an account? <a href="signup_admins.php" class="fw-bold">Sign up</a></p>
  </div>
</div>
