...
<head>
    ...
    <title>Parent Signup | BukSU Budget System</title>
...
<body>
    ...
    <div class="description-container d-none d-lg-block">
        ...
        <p>Parents Registration for SBO <br>Allocation & Management System</p>
    </div>

    <div class="container-fluid vh-100 d-flex justify-content-center align-items-center">
        <div class="card p-4 shadow signup-card">
            <h3 class="fw-bold text-center mt-2">Parent Signup</h3>
...
<div class="mt-2">
  ...
  ?>
            ...
            <form action="signup_validate_parents.php" method="POST">
                ...
                <div class="row g-2 mt-2">
                    ...
                    <div class="col-md-6 text-start">
                        ...
                        <input type="text" name="student_id_number" class="form-control" placeholder="Enter child's ID" required>
                    </div>
                </div>
                ...
                <div class="row g-2 mb-2">
                    <div class="col-md-12 text-start">
                        <label class="form-label">Child's Department</label>
                ...
                <button type="submit" class="btn btn-primary w-100 py-2 fw-bold mb-3 rounded-pill border: none;">
                    Create Parent Account
                </button>
            </form>

            <div class="text-center">
                <p class="small mb-0">Already have an account? <a href="login_parents.php" class="text-decoration-none fw-bold">Login</a></p>
            </div>
        </div>
    </div>
