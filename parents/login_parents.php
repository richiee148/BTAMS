...
<body>
  ...
  <div class="container-fluid vh-100 d-flex justify-content-center align-items-center">
    <div class="card p-5 shadow login-card">
      ...
      <!-- Login form -->
      <form action="validate_parents.php" method="POST">
        ...
        <div class="text-start mb-3">
          <a href="forgot_password_parents.php" class="text-decoration-none">Forgot password?</a>
        </div>
      ...
      <div class="d-flex justify-content-center gap-2 mb-4">
        <a href="google_login_parents.php" class="btn btn-google rounded-pill px-3"><i class="bi bi-google"></i></a>
      </div>

      <p class="text-center mb-0">Don’t have an account? <a href="signup_parents.php" class="fw-bold">Sign up</a></p>
    </div>
  </div>
