    ...
    if ($user) {
        ...
        if ($update->affected_rows > 0) {
            ...
            try {
                ...
                $mail->SMTPAuth   = true;
                $mail->Username   = 'richellemaedealdo@gmail.com'; // replace with your Gmail
                $mail->Password   = 'lffj tozs lyff jhne';   // replace with your Gmail App Password
                $mail->SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS;
                $mail->Port       = 587;

                // Email setup
                $mail->setFrom('support@yourdomain.com', 'SBOT-BTAMS');
                ...
                if ($mail->send()) {
                    ...
                    header("Location: verify_code_parents.php");
                    exit();
                } else {
                    $_SESSION['forgotpass_error'] = "Mailer Error: " . $mail->ErrorInfo;
                    header("Location: forgot_password_parents.php");
                    exit();
                }
            } catch (Exception $e) {
...
?>
      ...
      <form action="forgot_password_parents.php" method="POST">
      ...
      <div class="text-center">
        <p class="small mb-0 mt-2">Remembered your password? <a href="login_parents.php" class="text-decoration-none fw-bold">Login</a></p>
      </div>
    </div>
  </div>
